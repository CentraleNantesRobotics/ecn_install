...
sudo apt purge -qy thunderbird pidgin mousepad gnome-software xfburn gnome-mines sgt-puzzles sgt-launcher simple-scan transmission-gtk parole bluez blueman pavucontrol
...
# TODO users should belong to group `video` to remove GL errors
sudo sed -i 's/#EXTRA_GROUPS=/EXTRA_GROUPS=/g' /etc/adduser.conf
sudo sed -i 's/#ADD_EXTRA_GROUPS=/ADD_EXTRA_GROUPS=/g' /etc/adduser.conf
